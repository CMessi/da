...
class QueryList
{
    ...
    private function _request($url)
    {
        ...
        if(function_exists('curl_init')){
			...
			$header = array (   
				"Host:weibo.cn",
				"Referer:http://weibo.cn/search/mblog?hideSearchFrame=&keyword=%E7%94%9F%E5%A7%9C&page=6"
			 );  
			...
			curl_setopt ( $ch, CURLOPT_HEADER, 1 );//返回并输出response头部信息 
