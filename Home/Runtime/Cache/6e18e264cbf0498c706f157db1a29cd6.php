    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="panel panel-default">
          ...
          <?php if(is_array($fenci_types)): foreach($fenci_types as $key=>$v): ?><a href="__URL__/mng_main_misson_segmentation?type=<?php echo ($v["name_e"]); ?>&id=<?php echo $_GET[id]?>&task_name=<?php echo $_GET[task_name]?>">
              <button type="button" class="btn btn-outline btn-primary" id="type<?php echo ($v["name_e"]); ?>"><?php echo ($v["name_c"]); ?></button>
            ...
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="gradeA odd" role="row">
                    <td class="center"><?php echo ($v["fenci"]); ?></td>
                    <td class="center"><?php echo ($v["c"]); ?></td>
                    <td class="center">
                    <a href="__URL__/mng_main_misson_segmentation_detail?fenci=<?php echo ($v["fenci"]); ?>&id=<?php echo $_GET[id]?>">
                      <button type="button" class="btn btn-outline btn-primary btn-xs">详细</button>
                    </a>
                    <button type="button" class="btn btn-outline btn-primary btn-xs" onclick="delFenci('<?php echo ($v["fenci"]); ?>')">排除</button>
                    </td>
